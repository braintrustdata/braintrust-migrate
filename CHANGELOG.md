...
- Lower the default streaming event spill threshold to 3MB and make it configurable through `MIGRATION_EVENTS_MAX_EVENT_BYTES`, preventing individual spans below the 20MB per-span limit from exceeding intermediary gateway request limits.
